...
void VS_Init(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOD, ENABLE); //使能PB端口时钟
...
{ 
	...
	delay_ms(150);  
	VS_XDCS=1;
	ret = VS_RD_Reg(SPI_HDAT0);// VS1003如果得到的值为0x807F，则表明完好;VS1053为0X83FF.;       
	return ret;
}     					   
//向VS10XX写命令
//address:命令地址
